...
$app = [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Lavanderia Visconde'),
    ...
    */
    ...
    'url' => env('APP_URL', 'http://admin.lavanderiavisconde.com.br'),
    ...
    */
    ...
    'key' => 'base64:/j5MSu9BL+bYbdrnvL3ipz7d26foK5EwOtH26/1egSk=',
    ...
    */
    ...
    'providers' => [
        ...
        Lavanderia\Providers\ViewComposerServiceProvider::class,
...
if ('local' === env('APP_ENV', 'production')) {
    array_push($app['providers'], Barryvdh\Debugbar\ServiceProvider::class);
